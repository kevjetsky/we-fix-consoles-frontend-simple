...
export const metadata: Metadata = {
  ...
  description: 'Transparent console repair pricing in Houston, TX — HDMI, Ethernet and USB port repair, power supply and fan replacement, thermal service and deep cleaning for PlayStation 5, PlayStation 4, Xbox Series X|S, and Xbox One. We come to you.',
